...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menugc, MessageType.text, {quoted: ftroli})
           break
           case 'menufun':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menufun, MessageType.text, {quoted: ftroli})
           break
           case 'menuaudio':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuaudio, MessageType.text, {quoted: ftroli})
           break
           case 'menuabout':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuabout, MessageType.text, {quoted: ftroli})
           break
           case 'menudownload':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menudow, MessageType.text, {quoted: ftroli})
           break
           case 'menumedia':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menumedia, MessageType.text, {quoted: ftroli})
           break
           case 'rules':
           nuy.sendMessage(from, rules(name), text, {quoted: ftroli})
    	   break
           case 'gifstiker':
				case 'stiker':
				case 'sticker':
