	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         responseButton = (type == 'listResponseMessage') ? caa.message.listResponseMessage.title : ''
			...
			const katalog = (teks) => {
             nuy.sendMessage(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "Base: FxSx & FdlX", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftrolii})
         }
...
╰────────𖧹`
            ...
            case 'return':
				case '>':
				   if (!isOwner && !caa.key.fromMe) return replyca(mess.only.ownerB)
					return nuy.sendMessage(from, JSON.stringify(eval(body.slice(8))), text, {quoted: ftrolii})
					break
            case 'self':
			      if (!isOwner && !caa.key.fromMe) return replyca(mess.only.ownerB)
			      public = false
            ...
            case 'pale':
               ...
               nuy.sendMessage(from, pale, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berkali':
               if (isBanned) return replyca(mess.only.benned)
	         	const kali = fs.readFileSync('./mp3/berkali.mp3')
               nuy.sendMessage(from, kali, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sensei':
               if (isBanned) return replyca(mess.only.benned)
	         	const sei = fs.readFileSync('./mp3/sensei.mp3')
               nuy.sendMessage(from, sei, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'gatelsa':
               if (isBanned) return replyca(mess.only.benned)
	         	const tel = fs.readFileSync('./mp3/gatelsa.mp3')
               nuy.sendMessage(from, tel, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berpalinghati':
               if (isBanned) return replyca(mess.only.benned)
	         	const hati = fs.readFileSync('./mp3/berpalinghati.mp3')
               nuy.sendMessage(from, hati, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'bermainmusik':
               if (isBanned) return replyca(mess.only.benned)
	         	const moshik = fs.readFileSync('./mp3/bermainmusik.mp3')
               nuy.sendMessage(from, moshik, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'jamet':
               if (isBanned) return replyca(mess.only.benned)
	         	const met = fs.readFileSync('./mp3/jamet.mp3')
               nuy.sendMessage(from, met, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pembohong':
               if (isBanned) return replyca(mess.only.benned)
	         	const pem = fs.readFileSync('./mp3/pembohong.mp3')
               nuy.sendMessage(from, pem, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pala':
               if (isBanned) return replyca(mess.only.benned)
	         	const pa = fs.readFileSync('./mp3/pala.mp3')
               nuy.sendMessage(from, pa, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pam':
               if (isBanned) return replyca(mess.only.benned)
	         	const pam = fs.readFileSync('./mp3/pam.mp3')
               nuy.sendMessage(from, pam, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'loplop':
               if (isBanned) return replyca(mess.only.benned)
	         	const lop = fs.readFileSync('./mp3/lop.mp3')
               nuy.sendMessage(from, lop, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'totet':
               if (isBanned) return replyca(mess.only.benned)
	         	const tet = fs.readFileSync('./mp3/totet.mp3')
               nuy.sendMessage(from, tet, MessageType.audio, {quoted: ftrolii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'escebot':
               katalog('Esce Bot : Kepo Amat')
               break
             case 'uwu':
            buttons = [{buttonId: '!asupan', buttonText: {displayText: 'UWU UWU'}, type: 1}]
buttonsMessage = {
    contentText: `Hai ${pushname}\nSenang Bertemu Dengan Anda`,
...
nuy.sendMessage(from, buttonsMessage, MessageType.buttonsMessage, {quoted: ftroli, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n𝐼″𝐴𝑚 𝑋𝑖𝑒𝐵𝑜𝑡`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`,"thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/6283818221226"}}, quoted: ftroli})
               break
            case 'sticker':
			   case 'stiker':
				case 'stick':
...
// last
            ...
            case 'tupai':
               ...
               daftarimg = await getBuffer(ppimg)
					nuy.sendMessage(from, daftarimg, image, {quoted: ftrolii, contextInfo: { forwardingScore: 99999, isForwarded: true}, caption: captionnya})
					break
            case 'profile':
    				nuy.updatePresence(from, Presence.composing)
					if (!isUser) return replyca(mess.only.userB)
					...
					nuy.sendMessage(from, buff, image, {quoted: ftrolii, contextInfo: { forwardingScore: 99999, isForwarded: true}, caption: profile})
					break
				case 'bahasa':
				   if (isBanned) return replyca(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
				   nuy.sendMessage(from, bahasa(prefix), text, {quoted: ftrolii})
				   break
				case 'info':
               me = nuy.user
					user.push(sender)
               ...
               break
				case 'totaluser':
					...
					nuy.sendMessage(from, teks.trim(), extendedText, {quoted: ftrolii, contextInfo: {"mentionedJid": user}})
					break
            case 'chatlist':
		      case 'cekchat':
		         if (isBanned) return replyca(mess.only.benned)  
				   if (!isUser) return replyca(mess.only.userB)
			    	...
			    	nuy.sendMessage(from, teks, MessageType.text, {quoted: ftrolii})
		    		break
	    	   case 'blocklist':
					teks = 'List Block :\n'
					...
					nuy.sendMessage(from, teks.trim(), extendedText, {quoted: ftrolii, contextInfo: {"mentionedJid": blocked}})
					break 
			   case 'banlist':
				   ben = '```List Banned``` :\n'
					...
					nuy.sendMessage(from, ben.trim(), extendedText, {quoted: ftrolii, contextInfo: {"mentionedJid": ban}})
					break
				case 'ban':
					nuy.updatePresence(from, Presence.composing) 
