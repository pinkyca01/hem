...
✿➤ Untuk Memakai Pinky Bot
✿➤ Ketik : ${prefix}pinkyca`
	...
	nuy.on('chat-update', async (caa) => {
		...
		nuy.updatePresence(from, Presence.composing)
		if (messagesLink.includes(`${prefix}izinadmin`)) return reply(`*「 DITERIMA 」*\n\n${prefix}izinadmin`)
		var kic = `${sender.split('@')[0]}@s.whatsapp.net`
		reply(`*「 BADWORD TERDETEKSI 」*\nMaaf *${pushname2}*\nAnda Akan Segera Di Kick Dari Grup\n*${groupMetadata.subject}*`)
		setTimeout( () => {
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menugc, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'menufun':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menufun, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'menuaudio':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuaudio, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'menuabout':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuabout, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'menudownload':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menudow, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'menumedia':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menumedia, MessageType.text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
           break
           case 'rules':
           nuy.sendMessage(from, rules(name), text, {quoted: {key : {participant : `0@s.whatsapp.net`}, message: {orderMessage: {itemCount : 0, status: 999999999, surface : 999999999, message: ${name}\n${tampilHari}, orderTitle: ${name}\n${tampilHari}, thumbnail: fs.readFileSync('pinky.jpg'), sellerJid: `0@s.whatsapp.net`} } }, contextInfo: { forwardingScore: 999, isForwarded: true}})
    	   break
           case 'gifstiker':
				case 'stiker':
				case 'sticker':
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
			...
			if (!isUser) return reply(mess.only.userB)
				...
				case 'owner':
                 ...
                 nuy.sendMessage(from, '*Itu Owner Manca Bot, Chat² Aja Jangan Toxic Atau Ngomong Jorok!!*',text, { quoted: caa} )
                 break
                case 'fitnah':
                 if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
          ...
          contextInfo: { mentionedJid: [from] }
           ...
           nuy.sendMessage(from, options, text, { quoted: caa } )
                ...
                nuy.sendMessage(from, `\`\`\`âœ“Sukses Mengganti Nama Group Menjadi\`\`\` *${body.slice(9)}*`, text, {quoted: caa})
                break
                case 'setdesc':
                if (isBanned) return reply(mess.only.benned)    
                if (!isUser) return reply(mess.only.userB)
                ...
                nuy.sendMessage(from, `\`\`\`âœ“Sukses Mengganti Deskripsi Group\`\`\` *${groupMetadata.subject}* Menjadi: *${body.slice(9)}*`, text, {quoted: caa})
                break
				case 'tts':
				if (isBanned) return reply(mess.only.benned)    
				if (!isUser) return reply(mess.only.userB)
