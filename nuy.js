...
async function starts() {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         const cmd = (type === 'conversation' && caa.message.conversation) ? caa.message.conversation : (type == 'imageMessage') && caa.message.imageMessage.caption ? caa.message.imageMessage.caption : (type == 'videoMessage') && caa.message.videoMessage.caption ? caa.message.videoMessage.caption : (type == 'extendedTextMessage') && caa.message.extendedTextMessage.text ? caa.message.extendedTextMessage.text : (type == 'stickerMessage') && (getCmd(caa.message.stickerMessage.fileSha256.toString('hex')) !== null && getCmd(caa.message.stickerMessage.fileSha256.toString('base64')) !== undefined) ? getCmd(caa.message.stickerMessage.fileSha256.toString('base64')) : "".slice(1).trim().split(/ +/).shift().toLowerCase()
         const body = (type === 'conversation' && caa.message.conversation.startsWith(prefix)) ? caa.message.conversation : (type == 'imageMessage') && caa.message[type].caption.startsWith(prefix) ? caa.message[type].caption : (type == 'videoMessage') && caa.message[type].caption.startsWith(prefix) ? caa.message[type].caption : (type == 'extendedTextMessage') && caa.message[type].text.startsWith(prefix) ? caa.message[type].text : (type == 'listResponseMessage') && caa.message[type].singleSelectReply.selectedRowId ? caa.message[type].singleSelectReply.selectedRowId : (type == 'buttonsResponseMessage') && caa.message[type].selectedButtonId ? caa.message[type].selectedButtonId : (type == 'stickerMessage') && (getCmd(caa.message[type].fileSha256.toString('base64')) !== null && getCmd(caa.message[type].fileSha256.toString('base64')) !== undefined) ? getCmd(caa.message[type].fileSha256.toString('base64')) : ""
			const budy = (type === 'conversation') ? caa.message.conversation : (type === 'extendedTextMessage') ? caa.message.extendedTextMessage.text : '' 
			...
			const arg = body.substring(body.pinkyOf(' ') + 1)
      ...
      if (budy.startsWith('>')){
        ...
        replyca(e)
            ...
            case 'help':
               ...
               const buttons1 = [
                 {buttonId: `${prefix}menu2`, buttonText: {displayText: 'DAFTAR MENU'}, type: 1},
...
╰────────𖧹`
               buffer = await getBuffer('https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg')
               nuy.sendMessage(from, buffer, image, { "orderMessage": { "itemCount": 321, "message": allmenu, "footerText": "•°Base: FxSx & FdlX°•", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftrolii, contextInfo: {"forwardingScore":99999,"isForwarded":true},sendEphemeral: true})
               break
            case 'donasi': 
...
// last
            ...
            case 'creator':
               ...
               buttons = [{buttonId: '#info',buttonText:{displayText: 'INFO BOT'},type:1},{buttonId: '#allmenu',buttonText:{displayText:'ALL MENU'},type:1},{buttonId:`${prefix}donasi`,buttonText:{displayText:'DONASI BOT'},type:1]
               buttonsMessage = {
               contentText: `${txtt}`,
