	           ...
	           if (isGroup) {
	      				try {
	      					const getmemex = groupMembers.length
	      					    ...
	      					    fakeitem(`Maaf Xie Bot Tidak Bisa Masuk Ke Grup *${groupMetadata.subject}*\n\nMinimal Member Harus *${memberLimit}*`)
	      					setTimeout( () => {
	                         nuy.groupLeave(from)
                            }, 100)
                       	  	 setTimeout( () => {
	      		...
	      		setTimeout( () => {
	      		fakeitem(`Xie Bot Akan Segera Keluar Dari Group *${groupMetadata.subject}*`)
	      		}, 0)
	      		}
      ...
      if (budy.startsWith('>')){
        ...
        replyca(e)
            ...
            case 'creator':
               ...
               buttons = [{buttonId: '!donasi',buttonText:{displayText: 'DONASI BOT'},type:1},{buttonId:'!menuku',buttonText:{displayText:'DAFTAR MENU'},type:1},{buttonId:`${prefix}info`,buttonText:{displayText:'INFO BOT'},type:1]
