	...
	nuy.on('chat-update', async (caa) => {
		...
		reply(`*Sayonara Beban Grup*`)
            ...
            case 'help':
                ...
                nuy.relayWAMessage(pinky, {waitForAck: true})
                break
           case 'menugrup':
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menugc, MessageType.text, {quoted: caa})
           break
           case 'menufun':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menufun, MessageType.text, {quoted: caa})
           break
           case 'menuaudio':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuaudio, MessageType.text, {quoted: caa})
           break
           case 'menuabout':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuabout, MessageType.text, {quoted: caa})
           break
           case 'menudownload':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menudow, MessageType.text, {quoted: caa})
           break
           case 'menumedia':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menumedia, MessageType.text, {quoted: caa})
           break
           case 'rules':
           nuy.sendMessage(from, rules(name), text, {quoted: caa})
    	   break
           case 'gifstiker':
				case 'stiker':
				case 'sticker':
