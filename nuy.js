...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menugc, text, {quoted: ftroli})
           break
           case 'funmenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menufun, text, {quoted: ftroli})
           break
           case 'audiomenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuaudio, text, {quoted: ftroli})
           break
           case 'aboutmenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menuabout, text, {quoted: ftroli})
           break
           case 'downloadmenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menudow, text, {quoted: ftroli})
           break
           case 'mediamenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessage(from, menumedia, text, {quoted: ftroli})
           break
           case 'ownermenu':
                if (isBanned) return reply(mess.only.benned)
                if (!isUser) return reply(mess.only.userB)
...
┬𖧹
╰────────𖧹`
           nuy.sendMessageage(from, menuow, text, {quoted: ftroli})
           break
           case 'rules':
...
//akhir kreator
		    ...
		    case 'map':
				...
				if (!isGroupAdmins) return reply(mess.only.admin)
					...
					if ((args[0]) === 'on') {
						if (isSimi) return fakeitem('Simih Sudah On')
						samih.push(from)
						fs.writeFileSync('./database/simi.json', JSON.stringify(samih))
						fakeitem('「 *SUKSES* 」')
					} else if ((args[0]) === 'off') {
				    	if (isSimi) return fakeitem('Simih Sudah Off')
						samih.splice(from, 1)
						fs.writeFileSync('./database/simi.json', JSON.stringify(samih))
						fakeitem('「 *SUKSES* 」')
					} else {
