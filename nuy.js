...
async function starts() {
	...
	nuy.on('qr', () => {
		console.log(color('[','aqua'), color('Xie','aqua'), color(']','aqua'), color(' Kode Qr By NuyFaa', 'yellow'))
	})
    ...
    nuy.on('group-participants-update', async (anu) => {
		if (!welkom.includes(anu.jid)) return
            ...
            try {
	       	ppca = await nuy.getProfilePicture(mem)
		      } catch (e) {
	...
	nuy.on('chat-update', async (caa) => {
		try {
         ...
         responseButton = (type == 'listResponseMessage') ? caa.message.listResponseMessage.title : ''
			...
			const ftroliii = {key: {fromMe:false, participant:`0@s.whatsapp.net`, ...(from ? {remoteJid :"6283815956151-1604595598@g.us" }: {}) },message:{"orderMessage":{"orderId":"174238614569481","thumbnail": fs.readFileSync('pinky.jpg'),"itemCount":29,"status":"INQUIRY","surface":"CATALOG","message": name,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}}, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}\n${prefix}${command}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}
			
			const isUrl = (url) => {
			    return url.match(new RegExp(/https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_+.~#?&/=]*)/, 'gi'))
			}
			const replyca = (teks) => {
			    nuy.sendMessage(from, teks, text, {quoted: ftrolii, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}\n${command}`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}})
			}
			...
			const katalog = (teks) => {
             nuy.sendMessage(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "Base: FxSx & FdlX", "thumbnail": fs.readFileSync('pinky.jpg'), "surface": 'CATALOG' }}, {quoted: ftroliii})
         }
         ...
         mess = {
				...
				only: {
					...
					ownerB: '*Khusus Owner Xie Bot*',
					premium: '*Khusus Premium Xie Bot*',
	           ...
	           if (isGroup) {
	      				try {
	      					const getmemex = groupMembers.length
	      					    ...
	      					    replyca(`Maaf Xie Bot Tidak Bisa Masuk Ke Grup *${groupMetadata.subject}*\n\nMinimal Member Harus *${memberLimit}*`)
	      					setTimeout( () => {
	                         nuy.groupLeave(from)
                            }, 100)
                       	  	 setTimeout( () => {
      ...
      if (budy.startsWith('>')){
        ...
        replyca(e)
            ...
            if (!command) {console.log(color('[ MSG ]', 'aqua'), color(moment(caa.messageTimestamp * 1000).format('DD/MM/YY HH:mm:ss'), 'blue'), color(cmd, 'cyan'), color(`${pushname}`, 'white'), color(`${sender}`, 'aqua'))}
            switch(command) {
            ...
            case 'creator':
               ...
               nuy.sendMessage(from, {displayname: "nuy", vcard: vcard}, MessageType.contact, {quoted: ftrolii, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,"externalAdReply": {"title": `Hai ${pushname}\nKontak Owner XieBot`,"body": ``,"previewType": "PHOTO","thumbnailUrl": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/c/994409919080"}}})
               await sleep(1000)
               buttons = [
                 {buttonId: `${prefix}menuku`, buttonText: {displayText: 'DAFTAR MENU'}, type: 1},
                 {buttonId: `${prefix}donasi`, buttonText: {displayText: 'DONASI BOT'}, type: 1},
                 {buttonId: `${prefix}escebot`, buttonText: {displayText: 'ESCE BOT'}, type: 1}
               ]
               buttonsMessage = {
               contentText: `Hai Kak ${pushname}\nItu Ownerku`,
               footerText: 'Mohon Jangan Spam!',
               buttons: buttons,
               headerType: 1
               }
            ...
            case 'help':
               ...
               let imge = media.message["ephemeralMessage"] ? media.message.ephemeralMessage : media
               const buttons1 = [
                 {buttonId: `${prefix}menuku`, buttonText: {displayText: 'DAFTAR MENU'}, type: 1},
                 {buttonId: `${prefix}donasi`, buttonText: {displayText: 'DONASI BOT'}, type: 1},
               ...
               nuy.sendMessage(from, butt, MessageType.buttonsMessage, {quoted: ftroli, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n𝐼‘𝐴𝑚 𝑋𝑖𝑒𝐵𝑜𝑡`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`,"thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me"}}, quoted: ftroli})	
               break
            case 'menuku':
               if (isBanned) return replyca(mess.only.benned)
               if (!isUser) return replyca(mess.only.userB)
               list = []
               listmenu = [`aboutmenu`,`grupmenu`,`funmenu`,`downloadmenu`,`mediamenu`,`audiomenu`,`makermenu`,`ownermenu`,`allmenu`]
               listmenuu = [`Menu About`,`Menu Grup`,`Menu Fun`,`Menu Download`,`Menu Media`,`Menu Audio`,`Menu Maker`,`Menu Owner`,`Menu All`]
               urutan = 1
               startnum = 0
               for (let x of listmenu) {
               const fxsx = {title: '<⟨ Daftar Menu ⟩>' + urutan++,
                    rows: [
                       {
...
╰────────𖧹`
               ...
               nuy.sendMessage(from, buffer, image, {quoted: ftroli, caption: menuca, sendEphemeral: true, thumbnail: fs.readFileSync(`https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`, 'base64'), contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n𝐼″𝐴𝑚 𝑋𝑖𝑒𝐵𝑜𝑡`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`,"thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/6283818221226"}}, quoted: ftroli})
               break
            case 'grupmenu':
            menuca = `
╭──𖧹「 *INFO BOT* 」
...
╰────────𖧹`
               buffer = await getBuffer('https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg')
               nuy.sendMessage(from, buffer, image, {quoted: ftroli, caption: menuca, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n𝐼″𝐴𝑚 𝑋𝑖𝑒𝐵𝑜𝑡`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`,"thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/6283818221226"}}, quoted: ftroli})
               break
            case 'funmenu':
            menuca = `
╭──𖧹「 *INFO BOT* 」
...
╰────────𖧹`
               buffer = await getBuffer('https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg')
               nuy.sendMessage(from, buffer, image, {quoted: ftroli, caption: allmenu, contextInfo: {text: 'PinkyCaa',"forwardingScore": 99999,isForwarded: true,sendEphemeral: true,mentionedJid: [sender],"externalAdReply": {"title": `Hai Kak ${pushname}\n𝐼″𝐴𝑚 𝑋𝑖𝑒𝐵𝑜𝑡`,"body": ``,"previewType": "PHOTO","thumbnailUrl": `https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg`,"thumbnail": "https://i.ibb.co/fHXQHVZ/PinkyCaa.jpg","sourceUrl": "https://wa.me/6283818221226"}}, quoted: ftroli})
               break
            case 'donasi': 
            ...
            case 'return':
				case '>':
				   if (!isOwner && !caa.key.fromMe) return replyca(mess.only.ownerB)
					return nuy.sendMessage(from, JSON.stringify(eval(body.slice(8))), text, {quoted: ftroliii})
					break
            case 'self':
            ...
            case 'restart':
               if (!isOwner && !caa.key.fromMe) return replyca(mess.only.ownerB)
               exec(`node pinky`)
               replyca('*Sukses Restarting*')
               break
            case 'pale':
               if (isBanned) return replyca(mess.only.benned)
	         	const pale = fs.readFileSync('./mp3/pale.mp3')
               nuy.sendMessage(from, pale, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berkali':
               if (isBanned) return replyca(mess.only.benned)
	         	const kali = fs.readFileSync('./mp3/berkali.mp3')
               nuy.sendMessage(from, kali, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'sensei':
               if (isBanned) return replyca(mess.only.benned)
	         	const sei = fs.readFileSync('./mp3/sensei.mp3')
               nuy.sendMessage(from, sei, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'gatelsa':
               if (isBanned) return replyca(mess.only.benned)
	         	const tel = fs.readFileSync('./mp3/gatelsa.mp3')
               nuy.sendMessage(from, tel, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'berpalinghati':
               if (isBanned) return replyca(mess.only.benned)
	         	const hati = fs.readFileSync('./mp3/berpalinghati.mp3')
               nuy.sendMessage(from, hati, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'bermainmusik':
               if (isBanned) return replyca(mess.only.benned)
	         	const moshik = fs.readFileSync('./mp3/bermainmusik.mp3')
               nuy.sendMessage(from, moshik, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'jamet':
               if (isBanned) return replyca(mess.only.benned)
	         	const met = fs.readFileSync('./mp3/jamet.mp3')
               nuy.sendMessage(from, met, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pembohong':
               if (isBanned) return replyca(mess.only.benned)
	         	const pem = fs.readFileSync('./mp3/pembohong.mp3')
               nuy.sendMessage(from, pem, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pala':
               if (isBanned) return replyca(mess.only.benned)
	         	const pa = fs.readFileSync('./mp3/pala.mp3')
               nuy.sendMessage(from, pa, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'pam':
               if (isBanned) return replyca(mess.only.benned)
	         	const pam = fs.readFileSync('./mp3/pam.mp3')
               nuy.sendMessage(from, pam, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'loplop':
               if (isBanned) return replyca(mess.only.benned)
	         	const lop = fs.readFileSync('./mp3/lop.mp3')
               nuy.sendMessage(from, lop, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'totet':
               if (isBanned) return replyca(mess.only.benned)
	         	const tet = fs.readFileSync('./mp3/totet.mp3')
               nuy.sendMessage(from, tet, MessageType.audio, {quoted: ftroliii, mimetype: 'audio/mp4', ptt:true})
               break
            case 'escebot':
               katalog('Esce Bot : Kepo Amat')
               break
            case 'sticker':
			   case 'stiker':
				case 'stick':
            ...
            case 'takes':
               ...
               if (args.length == 0) return replyca(`Example: ${prefix + command} Xie/Bot`)
               const encmedia = isQuotedSticker ? JSON.parse(JSON.stringify(caa).replace('quotedM', 'm')).message.extendedTextMessage.contextInfo : caa
...
// makermenu
            ...
            case 'woodblock':
               ...
               nuy.sendMessage(from, buffer, image, {caption: 'Nih kak....', quoted: caa, contextInfo: { forwardingScore: 99999, isForwarded: true}})
               break
            case 'shadow2':
            case 'cup':
            case 'cup2':
            ...
            case 'fuckboy':
				...
				case 'badgirl':
				   ...
				   nuy.sendMessage(from, buffer, image, {quoted: caa, contextInfo: { forwardingScore: 99999, isForwarded: true}})
				   break
// End makermenu
// Anime
            case 'anime':
...
// last
            ...
            case 'img':
               ...
               await nuy.sendMessage(from, ini_buffer, image, {quoted: caa, contextInfo: { forwardingScore: 99999, isForwarded: true}})
               break
            case 'wallpaper':
               if (isBanned) return replyca(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
			   ...
			   case 'jadian':
				...
				case 'slow':
				   encmedia = JSON.parse(JSON.stringify(caa).replace('quotedM','m')).message.extendedTextMessage.contextInfo
					...
					buffer = fs.readFileSync(ran)
					nuy.sendMessage(from, buffer, audio, {mimetype: 'audio/mp4', ptt:true, quoted: caa, contextInfo: { forwardingScore: 99999, isForwarded: true}})
					fs.unlinkSync(ran)
					})
				   break
				case 'gemuk':
            ...
            case 'tupai':
               ...
               break
				case 'daftar':
					nuy.updatePresence(from, Presence.composing)
					if (isUser) return replyca('*Kamu Sudah Jadi User Xie Bot*')
					if (isBanned) return replyca(mess.only.benned)
					user.push(sender)
            ...
            case 'profile':
					...
					nuy.sendMessage(from, buff, image, {quoted: ftroliii, contextInfo: { forwardingScore: 99999, isForwarded: true}, caption: profile})
					break
				case 'bahasa':
				   if (isBanned) return replyca(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
				   nuy.sendMessage(from, bahasa(prefix), text, {quoted: ftroliii})
				   break
				case 'info':
               me = nuy.user
					user.push(sender)
               ...
               break
				case 'totaluser':
					...
					nuy.sendMessage(from, teks.trim(), extendedText, {quoted: ftroliii, contextInfo: {"mentionedJid": user}})
					break
            case 'chatlist':
		      case 'cekchat':
		         if (isBanned) return replyca(mess.only.benned)  
				   if (!isUser) return replyca(mess.only.userB)
			    	...
			    	nuy.sendMessage(from, teks, MessageType.text, {quoted: ftroliii})
		    		break
	    	   case 'blocklist':
					teks = 'List Block :\n'
					...
					nuy.sendMessage(from, teks.trim(), extendedText, {quoted: ftroliii, contextInfo: {"mentionedJid": blocked}})
					break 
			   case 'banlist':
				   ben = '```List Banned``` :\n'
					...
					nuy.sendMessage(from, ben.trim(), extendedText, {quoted: ftroliii, contextInfo: {"mentionedJid": ban}})
					break
				case 'ban':
					nuy.updatePresence(from, Presence.composing) 
            ...
            case 'setdesc':
		      ...
		      case 'tts':
		         if (isBanned) return replyca(mess.only.benned)    
				   if (!isUser) return replyca(mess.only.userB)
				   if (isLimit(sender)) return replyca(limitend(pushname))
					if (args.length < 1) return replyca(`Kode bahasanya mana Kak?\n Kalo Gatau Kode Bahasanya Apa Aja Ketik : *${prefix}bahasa*`)
					...
					rano = getRandom('.ogg')
					dtt.length > 500
					? replyca('Textnya Kebanyakan Kak')
					: gtts.save(ranm, dtt, function() {
						exec(`ffmpeg -i ${ranm} -ar 48000 -vn -c:a libopus ${rano}`, (err) => {
							fs.unlinkSync(ranm)
							buffer = fs.readFileSync(rano)
							if (err) return replyca('Gagal')
							nuy.sendMessage(from, buffer, audio, {quoted: caa, ptt:true})
							fs.unlinkSync(rano)
						})
					}) 
					await limitAdd(sender)
            ...
            case 'igstalk':
               ...
               randPinky = Math.floor(Math.random() * jsonData.length);
               randKey = jsonData[randPinky];
